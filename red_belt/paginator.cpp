...
public:
    Paginator(Iterator begin, Iterator end, size_t page_size){
        size_t page_number = (end - begin) / page_size;
        Iterator page_begin = begin;
        Iterator page_end;
        size_t last_elements = end - begin;
        page_end = next(page_begin, min(page_size, last_elements));
         while(page_begin != end){
             pages.push_back(MakeRange(page_begin, page_end));
             page_begin = page_end;
             last_elements = end - page_begin;
             page_end = next(page_begin, min(page_size, last_elements));
         }
    }
